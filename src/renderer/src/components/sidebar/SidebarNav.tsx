...
import { Bell, CalendarClock, ChevronRight, EyeOff, Search, Smartphone } from 'lucide-react'
...
import { AgentDashboardSidebarEntry } from './SidebarAgentDashboardEntry'
import { SidebarRemoteNavButton } from './SidebarRemoteNavButton'
